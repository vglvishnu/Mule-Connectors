...
import org.mule.modules.jira.generated.connectivity.JiraTestConnectorConfigConnectionManagementConnectionManager;
...
public class JiraTestConnectorConnectorConfigConfigDefinitionParser
    extends AbstractDevkitBasedDefinitionParser
{

    private static Logger logger = LoggerFactory.getLogger(JiraTestConnectorConnectorConfigConfigDefinitionParser.class);
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        ...
        setInitMethodIfNeeded(builder, JiraTestConnectorConfigConnectionManagementConnectionManager.class);
        setDestroyMethodIfNeeded(builder, JiraTestConnectorConfigConnectionManagementConnectionManager.class);
        parseProperty(builder, element, "userName", "userName");
        parseProperty(builder, element, "serverUrl", "serverUrl");
        parseProperty(builder, element, "pwd", "pwd");
        parseProperty(builder, element, "username", "username");
    ...
    private BeanDefinitionBuilder getBeanDefinitionBuilder(ParserContext parserContext) {
        try {
            return BeanDefinitionBuilder.rootBeanDefinition(JiraTestConnectorConfigConnectionManagementConnectionManager.class.getName());
